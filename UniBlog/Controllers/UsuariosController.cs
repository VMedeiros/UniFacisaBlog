...
namespace UniBlog.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuarioID,Nome,DataCadastro,Email")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioID,Nome,DataCadastro,Email")] Usuario usuario)
        {
